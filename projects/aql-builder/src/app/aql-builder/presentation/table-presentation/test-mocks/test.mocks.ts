...
export function getMockedEditorStateForDuplicatesMock(): EditorData {
  ...
  editorStateMock.additionalKeywordVariables = new Map<string, AdditionalAqlAutocompleteKeyword>()
    ...
    .set('m', AdditionalAqlAutocompleteKeyword.CLUSTER);
  editorStateMock.archetypeNameAndIdMap = new Map<string, string>()
    .set('Laboratory_context_details', 'openEHR-EHR-CLUSTER.lab_context_details.v0');

  editorStateMock.variableToArchetypeNameMap = new Map<string, string>()
    .set('m', 'Laboratory_context_details');

  editorStateMock.code = '"SELECT c\n' +
    'FROM EHR e\n' +
...
export function getMockEditorStateForMultipleTables(): EditorData {
  const editorStateMock: EditorData = new EditorData();
  editorStateMock.replacementMap = new Map<string, string>();
  editorStateMock.additionalKeywordVariables = new Map<string, AdditionalAqlAutocompleteKeyword>()
    .set('c', AdditionalAqlAutocompleteKeyword.COMPOSITION);
...
export function getActiveEditorStateMock() {
  const editorStateMock: EditorData = new EditorData();
  editorStateMock.replacementMap = new Map<string, string>();
  editorStateMock.additionalKeywordVariables = new Map<string, AdditionalAqlAutocompleteKeyword>()
      .set('e', AdditionalAqlAutocompleteKeyword.EHR)
      .set('c', AdditionalAqlAutocompleteKeyword.COMPOSITION)
      .set('w', AdditionalAqlAutocompleteKeyword.EVALUATION);
  editorStateMock.archetypeNameAndIdMap = new Map<string, string>()
    .set('Adverse_Reaction___Allergy', 'openEHR-EHR-EVALUATION.adverse_reaction-allergy.v1');

  editorStateMock.variableToArchetypeNameMap = new Map<string, string>()
    .set('w', 'Adverse_Reaction___Allergy');

  editorStateMock.code = 'SELECT w/data[at0001]/items[at0009],\n' +
...
export function getMockEditorStateForSquash(): EditorData {
  const editorStateMock: EditorData = new EditorData();
  editorStateMock.replacementMap = new Map<string, string>();
  editorStateMock.additionalKeywordVariables = new Map<string, AdditionalAqlAutocompleteKeyword>()
    .set('e', AdditionalAqlAutocompleteKeyword.EHR)
    .set('c', AdditionalAqlAutocompleteKeyword.COMPOSITION)
    .set('g', AdditionalAqlAutocompleteKeyword.EVALUATION);

  editorStateMock.archetypeNameAndIdMap = new Map<string, string>()
    .set('About_Me', 'openEHR-EHR-COMPOSITION.encounter.v1')
    .set('Generic_Assessments', 'openEHR-EHR-EVALUATION.generic_assessment_collection.v0');

  editorStateMock.variableToArchetypeNameMap = new Map<string, string>()
    .set('c', 'About_Me')
    .set('g', 'Generic_Assessments');

  editorStateMock.code = 'SELECT c/uid/value as cuid,\n' +
